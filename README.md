...
`DiceRoller` is a companion Android app for the **Udacity** course [Developing Android Apps in Kotlin](https://eu.udacity.com/course/developing-android-apps-with-kotlin--ud9012).
